...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        trinidad: {
          50: "hsl(var(--trinidad-50))", 100: "hsl(var(--trinidad-100))",
          200: "hsl(var(--trinidad-200))", 300: "hsl(var(--trinidad-300))",
          400: "hsl(var(--trinidad-400))", 500: "hsl(var(--trinidad-500))",
          600: "hsl(var(--trinidad-600))", 700: "hsl(var(--trinidad-700))",
          800: "hsl(var(--trinidad-800))", 900: "hsl(var(--trinidad-900))",
          950: "hsl(var(--trinidad-950))",
        },
      ...
      keyframes: {
        ...
        "pulse-glow": {
          "0%,100%": { boxShadow: "0 0 0 0 hsl(var(--trinidad-500) / 0.3)" },
          "50%": { boxShadow: "0 0 0 8px hsl(var(--trinidad-500) / 0)" },
        },
      },
      animation: {
