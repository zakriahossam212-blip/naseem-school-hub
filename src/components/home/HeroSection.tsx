...
import { ArrowLeft, BookOpen, Users, Award, Play, Sparkles, GraduationCap } from "lucide-react";
import { Button } from "@/components/ui/button";
import { useLang } from "@/contexts/LanguageContext";
import heroImg from "@/assets/hero-school.jpg";

const stats = [
  { icon: BookOpen, value: "+50", labelAr: "مقرر متاح", labelEn: "Courses", color: "text-blue-500", bg: "bg-blue-50 border-blue-200" },
  { icon: Users, value: "+500", labelAr: "طالب نشط", labelEn: "Students", color: "text-green-500", bg: "bg-green-50 border-green-200" },
  { icon: Award, value: "+30", labelAr: "معلم متميز", labelEn: "Teachers", color: "text-primary", bg: "bg-primary/10 border-primary/20" },
];
        ...
        <div className="grid grid-cols-3 gap-4 mt-14">
          {stats.map((stat, i) => (
            ...
            >
              ...
              <div className={`relative inline-flex items-center justify-center w-11 h-11 rounded-xl border mb-3 ${stat.bg}`}>
