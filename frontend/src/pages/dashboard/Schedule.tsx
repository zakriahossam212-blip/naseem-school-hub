...
import { DAY_ORDER, SCHEDULE_TYPE_COLORS } from "@/constants";
                    ...
                    <div key={day} className="bg-card border border-border rounded-2xl overflow-hidden shadow-depth-sm">
                      ...
                      <div className="p-3 space-y-2">
                        {dayEntries.map((entry) => (
                          <div key={entry.id} className={cn("rounded-xl border px-3 py-2.5 flex items-start gap-2", SCHEDULE_TYPE_COLORS[entry.type as keyof typeof SCHEDULE_TYPE_COLORS] || "bg-secondary border-border text-foreground")}>
              ...
              <div>
                ...
                <div className="space-y-2">
                  {upcomingSpecific.map((entry) => (
                    <div key={entry.id} className={cn("flex items-center gap-4 p-4 rounded-xl border", SCHEDULE_TYPE_COLORS[entry.type as keyof typeof SCHEDULE_TYPE_COLORS] || "bg-secondary border-border")}>
                      <div className="flex-1">
