...
interface Course { id: string; title: string; description: string | null; teacherId: string; }
interface Assignment { id: string; title: string; description: string | null; dueDate: string | null; maxGrade: number; }
...
export default function CourseDetail() {
  ...
  const load = async () => {
    ...
    setCourse(c);
    const a = await api.assignments.list({ courseId: id }).catch(() => []);
    setAssignments(a);
  };
